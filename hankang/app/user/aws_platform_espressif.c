...
#define product_model		"ESPRESSIF_HEALTH_RUNNINGMACHINE_TEST"//"DINGKANG_HEALTH_RUNNINGMACHINE_A4"
//#define product_secret		"YJJZjytOCXDhtQqip4EjWbhR95zTgI92RVjzjyZF"
#define product_secret		"19n2KDP5TYW7nKY5Bw9ArE4VBzU4IO6RpuiIFQdA"//"3zHS0q4hctA0i6jWvX04B1imA7nuzK8judd47O8q"
#endif

#if 0 //from xutao
#define product_model		"ESPRESSIF_HEALTH_RUNNINGMACHINE_TEST"
#define product_secret		"EhySq0C4kyuSbey6eB7wYwJcubYZahX2F5fACFjf"

#endif


#if 0//20170217
#define product_model		"DINGKANG_HEALTH_RUNNINGMACHINE_ELF"//"DINGKANG_HEALTH_RUNNINGMACHINE_A4"
#define product_secret		"IPwETGEJ2kTTUV3pLOm6JtexPIzydIRXuw1hgFyv"//"3zHS0q4hctA0i6jWvX04B1imA7nuzK8judd47O8q"
#endif

#define product_model		"DINGKANG_HEALTH_RUNNINGMACHINE_ELF"
#define product_secret		"IPwETGEJ2kTTUV3pLOm6JtexPIzydIRXuw1hgFyv"
...
int aws_sample(void)
{
	...
	os_printf("dev mac:%s\n",dev_mac);
//victor
	getssidpasswdflag=1;//open counter
//-----------------------------------v
...
//victor
	ret=vendor_connect_ap(ssid, passwd);
	if(!ret){
		aws_printf("vendor connect ap timeout!\n");
		
		ret=-1;
		goto out;
	}
//victor
	getssidpasswdflag=0;//close counter
//-----------------------------------v
